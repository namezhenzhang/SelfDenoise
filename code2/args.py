...
class ClassifierArgs(ProgramArgs):
    def __init__(self):
        ...
        self.seed = 1   # for seed of all random function(including, np.random, random, torch, so on.)
        ...
        self.caching_dir = 'cache_path'  # for cache path
        self.saving_dir = 'save_models'  # for saving modeling
        self.logging_dir = 'result_log'  # for logging
        ...
        self.sentiment_path = 'dataset/sentiment_word/sentiment-words.txt'
        ...
        self.denoise_method = 'N'
        self.predictor = 'N'
        self.mask_word = '<mask>'
        self.local_rank=0
        self.alpaca_batchsize=1
        self.world_size=1
        self.save_path=None
        self.recover_past_data=False
